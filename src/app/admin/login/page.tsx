        ...
        <div className="sq-auth-card">
          <div className="sq-card sq-fade-in" style={{ padding: 40 }}>
            ...
            <div style={{ marginBottom: 18 }}>
              <label className="sq-label">Admin Email</label>
              <input
                type="email"
            ...
            <button
              ...
              style={{ marginBottom: 24, opacity: loading ? 0.7 : 1 }}
            >
            ...
            <div style={{
              ...
              🔒 This portal is restricted to system administrators only. Unauthorised access attempts are logged.
            </div>
